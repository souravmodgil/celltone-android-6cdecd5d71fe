...
public class UploadMediaList {
    ...
    @Expose
    private java.util.List<Object> genre = null;
    @SerializedName("category")
    @Expose
    private java.util.List<Object> category = null;
    ...
    public java.util.List<Object> getGenre() {
        return genre;
    }

    public void setGenre(java.util.List<Object> genre) {
        this.genre = genre;
    }

    public java.util.List<Object> getCategory() {
        return category;
    }

    public void setCategory(java.util.List<Object> category) {
