...
public class ContactFetcher {
    ...
    public Map<String, String> fetchAllContact() {
        ...
        return matchContactNumber(contactsMap);
    }
    ...
    public Map<String, String> matchContactNumber(Map<String, Contact> contactsMap) {
        // Get numbers
