package com.mobileoid2.celltone.CustomWidget.Surface;
...
public class CameraPreview extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public void surfaceChanged(SurfaceHolder holder, int format, int w, int h) {
        ...
        try {
            ...
            if (continousAutoFocusAvailable())
    ...
    boolean continousAutoFocusAvailable() {
        ...
        supportedMode = focusModes.contains(CAF_PICTURE) ? CAF_PICTURE :
                focusModes.contains(CAF_VIDEO) ? CAF_VIDEO : "";
